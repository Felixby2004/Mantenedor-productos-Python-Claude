...
# Importar el generador de PDFs (ahora en la misma carpeta frontend)
...
/* Cambia el color de la etiqueta (Label) */
div[data-testid="stTextInput"] label {
    color: #1E3A5F !important;
    font-weight: bold;
}

/* Cambia el color del texto escrito dentro del input */
...
with st.sidebar:
    ...
    <div style="text-align:center; padding: 0.5rem 0 1rem;">
        ...
        <div style="font-size:1.1rem; font-weight:700; color:#1E3A5F; margin-top:0.3rem;">
